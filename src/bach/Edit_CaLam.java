...
public class Edit_CaLam extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TC_UPdate.setBackground(new java.awt.Color(255, 0, 0));
        TC_UPdate.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        TC_UPdate.setForeground(new java.awt.Color(255, 255, 255));
        TC_UPdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-support-24.png"))); // NOI18N
        ...
        Exit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-exit-26.png"))); // NOI18N
        Exit.setText("Thoát");
    ...
    private void TC_UPdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TC_UPdateActionPerformed
       Connection conn = connection.ConnectMySQL();
        ...
        if(manv.equals("") || macl.equals("")){
            ...
            try {
                CallableStatement cSmt1 = (CallableStatement) conn.prepareCall("{call kt_nv_trung(?,?,?)}");
