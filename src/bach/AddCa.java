...
public class AddCa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-add-book-30.png"))); // NOI18N
        ...
        TC_Ngay.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TC_NgayActionPerformed(evt);
            }
        });
        ...
        TC_Nam.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TC_NamActionPerformed(evt);
            }
        });
        ...
        TC_Add.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-add-24.png"))); // NOI18N
        ...
        Exit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-exit-24.png"))); // NOI18N
        Exit.setText("Thoát");
        ...
        jButtonPrint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-print-24.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(TC_Add, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private String chucvu(String cv){
        ...
        switch (cv){
            ...
            case "Giám Đốc" : {CV =  "GD"; break;}
            case "Kế Toán" : {CV =  "KT"; break;}
        }
        return CV;
    }
    ...
    private void jButtonPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintActionPerformed
        ...
        DefaultTableModel tabCa = new DefaultTableModel();
        tabCa = (DefaultTableModel) DS_CaLam.getModel();
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                for (int i = 0; i < tabCa.getRowCount(); i++) {
                    for (int j = 0; j < tabCa.getColumnCount(); j++) {
                        bw.write(tabCa.getValueAt(i, j).toString());
                    }
                    bw.newLine();
                }
    ...
    private void TC_NamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TC_NamActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TC_NamActionPerformed

    private void TC_NgayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TC_NgayActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TC_NgayActionPerformed
    ...
    private void initCombobox(){
        try {
            ...
            TC_Box_CV.removeAllItems();
            while(rs.next()){
                TC_Box_CV.addItem(rs.getString("ten_cv"));
            }
            rs.close();
            pstmt.close();
            conn.close();
